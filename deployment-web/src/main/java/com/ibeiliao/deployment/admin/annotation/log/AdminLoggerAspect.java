...
public class AdminLoggerAspect {
	...
	@AfterReturning(value = "within(com.ibeiliao.deployment.admin..*) && @annotation(adminLog)", returning = "obj")
	...
	@AfterThrowing(pointcut = "within(com.ibeiliao.deployment.admin..*) && @annotation(adminLog)", throwing = "ex")
