...
<div class="wrapper">
	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
				<li><a href="/admin/account/listRole.xhtml"><i class="fa fa-dashboard"></i> 角色列表</a></li>
			</ol>
		</section>
			...
			$.post('/admin/account/updateRole.do', {
				...
				if (json.success) {
					BootstrapDialog.alert(json.message, function() {
						window.location.href = "/admin/account/listRole.xhtml";
					});
				}
				else {
					BootstrapDialog.alert(json.message);
